...
It's not just an auto-scroller; it's a premium utility designed to feel like a native part of Instagram, complete with a beautiful UI and intuitive controls.

## ✨ Features

### 🔄 Intelligent Auto-Scroll
- **Smart Detection**: Automatically detects when a video finishes and scrolls to the next one instantly.
- **Loop Prevention**: Disables the default loop behavior so you never get stuck watching the same Reel twice.
- **Smooth Transition**: Uses smooth scrolling for a pleasing visual experience.

### 🎛️ Premium Control Center
- **On-Screen Toggle**: A sleek, draggable (planned) toggle button injected directly onto the Reels page for quick access.
...
Since this extension is currently in **Developer Mode**, follow these simple steps to install it:
...
4.  **Load Unpacked**:
    ...
    - Select the folder where you extracted the files (the one containing `manifest.json`).
...
- **Show Toggle**: Choose whether to display the floating button on the Instagram page itself.
...
- **APIs**: `chrome.storage`, `chrome.scripting`, `MutationObserver`, `IntersectionObserver`

## 🔒 Privacy

**Reels Flow** respects your privacy.
- **No Data Collection**: We do not collect, store, or transmit any of your personal data or browsing history.
